...
import edgeville.game.location.Palette;
import edgeville.game.location.PaletteTile;
...
public final class OutputMessages {
    ...
    public OutputMessages sendUpdateSpecial(int id, int amount) {
        ...
        msg.newMessage(70);
        msg.putShort(amount);
        msg.putShort(0, edgeville.net.ByteOrder.LITTLE);
        msg.putShort(id, edgeville.net.ByteOrder.LITTLE);
        player.getSession().queue(msg);
        return this;
    }
    ...
    public OutputMessages sendItemsOnInterface(int id, Item[] items, int length) {
        ...
        if (items == null) {
            msg.putShort(0);
            msg.put(0);
            msg.putShort(0, edgeville.net.ValueType.A, edgeville.net.ByteOrder.LITTLE);
            msg.endVarShortMessage();
            player.getSession().queue(msg);
            return this;
        }
        ...
        for (Item item : items) {
            if (item != null) {
                if (item.getAmount() > 254) {
                    msg.put(255);
                    msg.putInt(item.getAmount(), edgeville.net.ByteOrder.INVERSE_MIDDLE);
                } else {
                    msg.put(item.getAmount());
                }
                msg.putShort(item.getId() + 1, edgeville.net.ValueType.A, edgeville.net.ByteOrder.LITTLE);
            } else {
                msg.put(0);
                msg.putShort(0, edgeville.net.ValueType.A, edgeville.net.ByteOrder.LITTLE);
            }
    ...
    public OutputMessages sendContextMenu(int slot, String option) {
        ...
        msg.put(slot, edgeville.net.ValueType.C);
        msg.put(0, edgeville.net.ValueType.A);
    ...
    public OutputMessages sendMapRegion() {
        ...
        MessageBuilder msg = MessageBuilder.create();
        msg.newMessage(73);
        msg.putShort(player.getPosition().getRegionX() + 6, edgeville.net.ValueType.A);
