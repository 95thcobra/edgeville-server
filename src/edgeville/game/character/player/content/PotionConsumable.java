...
import static edgeville.game.character.player.skill.Skills.AGILITY;
import static edgeville.game.character.player.skill.Skills.ATTACK;
import static edgeville.game.character.player.skill.Skills.DEFENCE;
import static edgeville.game.character.player.skill.Skills.FISHING;
import static edgeville.game.character.player.skill.Skills.HITPOINTS;
import static edgeville.game.character.player.skill.Skills.MAGIC;
import static edgeville.game.character.player.skill.Skills.PRAYER;
import static edgeville.game.character.player.skill.Skills.RANGED;
import static edgeville.game.character.player.skill.Skills.STRENGTH;
